...
def fetch_data(s,e):
    ...
    if (user_start_date == db_start_date) and (user_end_date == db_end_date):  # U.S = D.S and U.E. = D.E
        ...
        plt.title('Rpm values generated for given date range', fontsize=70)
        ...
        plt.title('Vibration values generated for given date range', fontsize=70)
        ...
        plt.title('Temperature generated for given date range', fontsize=70)
        ...
        plt.title('Pressure generated for given date range', fontsize=70)
        ...
        plt.xlabel('Date Range', fontsize=50)
        plt.ylabel('Pressure Values', fontsize=50)
        plt.title('Pressure generated for given date range', fontsize=50)
